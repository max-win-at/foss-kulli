...
describe('VmStickyNote', () => {
  describe('constructor', () => {
    it('sets id, text, x, y correctly', () => {
      const note = new VmStickyNote('note-1', 'Hello', 100, 200);
    ...
    it('defaults createdAt to current date when not provided', () => {
      ...
      const note = new VmStickyNote('note-1', 'Hello', 0, 0);
    ...
    it('converts an ISO string createdAt to a Date object', () => {
      ...
      const note = new VmStickyNote('note-1', 'Hello', 0, 0, iso);
    ...
    it('accepts a Date object for createdAt', () => {
      ...
      const note = new VmStickyNote('note-1', 'Hello', 0, 0, date);
    ...
    it('accepts a numeric timestamp for createdAt', () => {
      ...
      const note = new VmStickyNote('note-1', 'Hello', 0, 0, ts);
    ...
    it('stores empty string text', () => {
      const note = new VmStickyNote('note-1', '', 0, 0);
      expect(note.text).toBe('');
    });

    it('stores zero coordinates', () => {
      const note = new VmStickyNote('note-1', 'Hi', 0, 0);
  ...
  describe('formattedDate', () => {
    it('returns a string containing the date and time', () => {
      const note = new VmStickyNote('note-1', 'Hello', 0, 0, '2025-06-15T14:30:00Z');
    ...
    it('formats time with 2-digit hour and minute', () => {
      ...
      const note = new VmStickyNote('note-1', 'Hello', 0, 0, '2025-01-01T08:05:00Z');
      const formatted = note.formattedDate;
